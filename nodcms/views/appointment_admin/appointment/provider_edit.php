<div class="portlet">
    <div class="portlet-body">
        ...
        <div class="form-body">
            <?php
            mk_htext("data[provider_name]",_l('Provider Name',$this),isset($data['provider_name'])?$data['provider_name']:'');
            mk_htext("data[provider_username]",_l('Provider Unique Name',$this),isset($data['provider_username'])?$data['provider_username']:'');
            foreach ($languages as $item) {
                ...
                <div class="lang_value<?php echo $item['language_id']; ?>" <?php echo (isset($extensions[$item["language_id"]]['status']) && $extensions[$item["language_id"]]['status']==1)?'':'style="display:none;"'; ?>>
                    <?php
                    mk_htext("extensions[".$item["language_id"]."][name]",_l('Provider Name',$this)." (".$item["language_name"].")",isset($extensions[$item["language_id"]])?$extensions[$item["language_id"]]["name"]:"");
                    mk_htexteditor("extensions[".$item["language_id"]."][full_description]",_l('Provider Description',$this)." (".$item["language_name"].")",isset($extensions[$item["language_id"]])?$extensions[$item["language_id"]]["full_description"]:"");
                    ?>
                </div>
                <?php
            }
